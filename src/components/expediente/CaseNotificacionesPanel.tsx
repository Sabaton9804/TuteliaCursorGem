    ...
    <section className="rounded-2xl border border-indigo-100 bg-indigo-50/40 p-4 sm:p-5">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <h3 className="text-sm font-bold text-slate-900">Oficios de notificación (secretaría)</h3>
          <p className="mt-1 text-xs leading-snug text-slate-600">
            Genera el PDF del oficio y regístralo como acto procesal. Después puede enviarlo por correo
            institucional y archivar la constancia.
          </p>
        </div>
      </div>
