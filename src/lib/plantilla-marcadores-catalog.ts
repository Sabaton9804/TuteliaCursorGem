...
export const MARCADORES_CATALOGO: MarcadorCatalogoItem[] = [
  ...
  {
    clave: 'ACCIONANTE',
    etiqueta: 'Demandante / Accionante',
    grupo: 'partes',
    ayuda: 'Nombre de quien interpone (civil: demandante; tutela: accionante)',
    soloTipo: 'auto_admisorio',
  },
  {
    clave: 'ACCIONADO_PRINCIPAL',
    etiqueta: 'Demandado / Accionado principal',
    grupo: 'partes',
    ayuda: 'Principal demandado (civil) o accionado (tutela)',
    soloTipo: 'auto_admisorio',
  },
  {
    clave: 'ACCIONANTE_COMPLETO',
    etiqueta: 'Demandante / Accionante con datos',
    grupo: 'partes',
  ...
  },
  {
    ...
    etiqueta: 'Lista de demandados / accionados',
    grupo: 'partes',
  ...
  },
  {
    ...
    grupo: 'proceso',
    ayuda: 'Ej. tutela de primera instancia / civil declarativo',
    soloTipo: 'informe_ingreso',
  },
  {
    clave: 'INFORME_NATURALEZA',
    etiqueta: 'Naturaleza (tutela o demanda civil)',
    grupo: 'proceso',
    ayuda: 'Tutela: «acción de tutela…». Civil: «demanda de [clase SIERJU]».',
    soloTipo: 'informe_ingreso',
  },
  {
    clave: 'INFORME_VERB_PRESENTADA',
    etiqueta: 'Verbo (promovida / presentada)',
    grupo: 'proceso',
    ayuda: 'Tutela: promovida. Civil: presentada.',
    soloTipo: 'informe_ingreso',
  },
  {
    clave: 'INFORME_CLAUSULA_OBJETO',
    etiqueta: 'Cláusula de objeto (solo tutela)',
    grupo: 'proceso',
    ayuda:
      'En tutela 1ª: derecho fundamental. En tutela 2ª: impugnación del fallo del juzgado de origen + derecho invocado. En civil queda vacío.',
    soloTipo: 'informe_ingreso',
  },
  {
    clave: 'INFORME_CLAUSULA_ORIGEN',
    etiqueta: 'Cláusula de origen (solo tutela 2ª)',
    grupo: 'proceso',
    ayuda:
      'Impugnación del fallo de primera instancia. En plantillas nuevas puede usarse aparte; la plantilla por defecto ya lo incluye en «Cláusula de objeto».',
    soloTipo: 'informe_ingreso',
  },
  {
    clave: 'JUZGADO_ORIGEN',
    etiqueta: 'Juzgado de primera instancia',
    grupo: 'proceso',
    ayuda: 'Despacho que conoció y falló la tutela en origen (2ª instancia).',
    soloTipo: 'informe_ingreso',
  },
  {
    clave: 'RADICADO_ORIGEN',
    etiqueta: 'Radicado de primera instancia',
    grupo: 'proceso',
    ayuda: 'CUI del proceso en el juzgado de origen.',
    soloTipo: 'informe_ingreso',
  },
  {
    clave: 'FALLO_ORIGEN_SENTIDO',
    etiqueta: 'Sentido del fallo de origen',
    grupo: 'proceso',
    ayuda: '«concedió la tutela» o «negó la tutela».',
    soloTipo: 'informe_ingreso',
  },
  {
    clave: 'IMPUGNANTE',
    etiqueta: 'Quién impugna',
    grupo: 'proceso',
    ayuda: '«el accionante» o «el accionado».',
    soloTipo: 'informe_ingreso',
  },
  {
    clave: 'INFORME_RECEPCION',
    etiqueta: 'Frase de recepción',
    grupo: 'proceso',
    ayuda: '«La acción/demanda fue recibida por…»',
    soloTipo: 'informe_ingreso',
  },
  {
    clave: 'INFORME_PARTE_ACTORA',
    etiqueta: 'Parte actora (compacta)',
    grupo: 'proceso',
    ayuda: 'Demandante(s) o accionante(s); si hay varios, «X y otros».',
    soloTipo: 'informe_ingreso',
  },
  {
    clave: 'INFORME_PARTE_PASIVA',
    etiqueta: 'Parte pasiva (compacta)',
    grupo: 'proceso',
    ayuda: 'Demandado(s) o accionado(s); si hay varios, «X y otros».',
    soloTipo: 'informe_ingreso',
  },
  {
